// ManhwaIndo.my HTTP client. WordPress + mangareader theme, CF Bot Fight
// on pages — hybrid fetch (plain fetch + Puppeteer MY_BROWSER fallback).
export const MANHWA_BASE = 'https://www.manhwaindo.my';

export const MANHWA_UA =
...
export interface ManhwaFetchEnv {
  MY_BROWSER?: Fetcher;
}
...
// Fetch HTML. Tries plain fetch first; on Cloudflare challenge falls back to
// remote browser (MY_BROWSER Puppeteer binding).
export const fetchHtml = async (url: string, env?: ManhwaFetchEnv, timeoutMs = 15000): Promise<string> => {
