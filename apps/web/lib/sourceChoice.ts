...
// Sebelumnya tiap surface memilih sendiri (landing pakai urutan array search,
// detail pakai resolved.source, switcher pakai localStorage) → badge landing
// dan badge halaman komik bisa beda untuk judul yang sama.
//
