  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-8 sm:py-10">
      ...
      <section className="admin-card mb-5 overflow-hidden">
        <div className="p-5 pb-3">
          <SectionHead title="Load balancer accounts" hint="Round-robin worker · status akun + health origin + request hari ini"
            action={<Link href="/admin/settings" className="text-xs text-secondary hover:text-accent transition-colors">Kelola →</Link>} />
        </div>
        {lbAccounts.length === 0 ? (
        ...
        <section className="admin-card overflow-hidden">
          <div className="p-5 pb-3">
            <SectionHead title="Users terbaru" hint={`${fmtNum(usersTotal)} total · +${users7d} minggu ini`}
              action={<Link href="/admin/users" className="text-xs text-secondary hover:text-accent transition-colors">Kelola →</Link>} />
          </div>
          <table className="w-full text-sm">
            <tbody>
      ...
      <nav className="flex flex-wrap gap-2">
        <Link href="/admin/monitoring" className="px-4 py-2 text-sm text-primary border border-border-default rounded-full hover:bg-bg-secondary transition-colors">Monitoring →</Link>
        <Link href="/admin/users" className="px-4 py-2 text-sm text-primary border border-border-default rounded-full hover:bg-bg-secondary transition-colors">Users →</Link>
        <Link href="/admin/merge" className="px-4 py-2 text-sm text-primary border border-border-default rounded-full hover:bg-bg-secondary transition-colors">Merge Queue →</Link>
        <Link href="/admin/settings" className="px-4 py-2 text-sm text-primary border border-border-default rounded-full hover:bg-bg-secondary transition-colors">Settings →</Link>
      </nav>
    </main>
  );
}
