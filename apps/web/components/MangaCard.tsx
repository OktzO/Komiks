...
export function MangaCard({ manga, source = 'komiku', sources, status, type }: { manga: { id: string; title: string; cover: string | null; slug: string }; source?: string; sources?: string[]; status?: string | null; type?: string | null }) {
  return (
