...
const TURNSTILE_SITE_KEY = (import.meta.env as Record<string, string | undefined>).PUBLIC_TURNSTILE_SITE_KEY || '';
const TURNSTILE_SCRIPT = 'https://challenges.cloudflare.com/turnstile/v0/api.js?render=explicit&onload=onTurnstileLoad';
      ...
      <div className="relative z-10 w-full max-w-sm anim-slide-up">
        <div className="panel p-7 sm:p-8 shadow-[0_24px_64px_-32px_oklch(0%_0_0/0.7)]">
          ...
          {TURNSTILE_SITE_KEY ? (
            ...
            // ponytail: tanpa PUBLIC_TURNSTILE_SITE_KEY → widget disembunyikan;
